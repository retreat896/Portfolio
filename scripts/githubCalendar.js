      ...
      1: [
        function (e, t, r) {
          ...
          t.exports = function (d, e, f) {
            (d = p(d)),
              ((f = f || {}).summary_text = f.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>"),
                ...
                return f
                  ...
                  .then(function (e) {
                    ...
                    e.querySelector("include-fragment")
                      ? setTimeout(l, 500)
                      : (!0 === f.responsive &&
                          ((o = (r = e.querySelector("table.js-calendar-graph-table")).getAttribute("width")),
                        ...
                        !1 !== f.global_stats &&
                          ((o = (r = b(e.innerHTML)).current_streak
                            ? m(r.current_streak_range[0], y) + " &ndash; " + m(r.current_streak_range[1], y)
                            : r.last_contributed
                            ? "Last contributed in " + m(r.last_contributed, y) + "."
                            : "Rock - Hard Place"),
                          (u = r.longest_streak ? m(r.longest_streak_range[0], y) + " &ndash; " + m(r.longest_streak_range[1], y) : r.last_contributed ? "Last contributed in " + m(r.last_contributed, y) + "." : "Rock - Hard Place"),
                          (t = p("<div>", {
                            ...
                            html:
                              ...
                              m(g.add(g.subtract(new Date(), 1, "year"), 1, "day"), h) +
                              " &ndash; " +
                              m(new Date(), h) +
                              "</span>",
                          })),
                        ...
                        !0 === f.tooltips &&
                          ((o = d),
                          (n = document.createElement("div")).classList.add("day-tooltip"),
                          o.appendChild(n),
                          o.querySelectorAll(".js-calendar-graph-svg rect.ContributionCalendar-day").forEach(function (e) {
            ...
            return (
              e
                ...
                .forEach(function (e) {
                  ...
                  t &&
                    ((r = { fill: u[t], date: new Date(r), count: e, level: t }),
                    0 === a.current_streak && (a.current_streak_range[0] = r.date),
                    0 === a.current_break && (a.current_break_range[0] = r.date),
                    r.count
                      ? (++a.current_streak,
                        (a.last_year += r.count),
                        (a.last_contributed = r.date),
                        (a.current_streak_range[1] = r.date),
                        a.longest_break < a.current_break && ((a.longest_break = a.current_break), (a.longest_break_range[0] = a.current_break_range[0]), (a.longest_break_range[1] = a.current_break_range[1])),
                        (a.current_break = 0))
                      : (n(), (a.current_streak = 0), ++a.current_break, (a.current_break_range[1] = r.date)),
                    o.push(r),
                    a.days.push(r));
                }),
              n(),
